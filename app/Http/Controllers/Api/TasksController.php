...
{
    /**
     * الحصول على المهام بناءً على رقم التليفون
     */
    public function getTasksByPhone(Request $request)
    {
        ...
        // جلب المهام المخصصة لهذا الموظف
    ...
    /**
     * الحصول على تفاصيل مهمة معينة بناءً على رقم التليفون و ID المهمة
     */
