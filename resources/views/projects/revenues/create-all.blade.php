...
@section('page-description', 'إضافة إيراد جديد لأي مشروع')
...
<div class="container mx-auto px-4">
    <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">إضافة إيراد جديد لأي مشروع</p>
                    </div>
                </div>
        ...
        <div class="card rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('revenues.store') }}" class="space-y-8" enctype="multipart/form-data">
                @csrf
