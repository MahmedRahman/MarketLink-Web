...
<div class="space-y-6">
    ...
    <div class="card rounded-2xl p-6">
        ...
        <div class="flex flex-wrap gap-4">
            <!-- All Card -->
            <a href="{{ route('revenues.all') }}" class="monthly-record-card flex-1 min-w-[150px] max-w-[200px] p-4 rounded-xl border-2 transition-all cursor-pointer {{ !request('record_month_year') ? 'border-primary bg-primary-50' : 'border-gray-200 hover:border-primary hover:bg-gray-50' }}">
            ...
            @foreach($monthlyRecords as $record)
                @php
                    ...
                    $count = $record['count'];
                @endphp
                <a href="{{ route('revenues.all', ['record_month_year' => $recordMonth]) }}" class="monthly-record-card flex-1 min-w-[150px] max-w-[200px] p-4 rounded-xl border-2 transition-all cursor-pointer {{ $isActive ? 'border-primary bg-primary-50' : 'border-gray-200 hover:border-primary hover:bg-gray-50' }}">
                    <div class="text-center">
