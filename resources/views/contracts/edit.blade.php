...
@section('page-description', 'تعديل بيانات العقد')
        ...
        <div class="card page-header rounded-2xl p-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">تعديل العقد</h2>
                        <p class="text-gray-600">تعديل بيانات العقد: {{ $contract->employee->name ?? 'الموظف' }}</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="hourly" {{ old('payment_type', $contract->payment_type) === 'hourly' ? 'selected' : '' }}>بالوقت</option>
                                <option value="project" {{ old('payment_type', $contract->payment_type) === 'project' ? 'selected' : '' }}>بالمشروع</option>
                                <option value="piece" {{ old('payment_type', $contract->payment_type) === 'piece' ? 'selected' : '' }}>بالقطعة</option>
                            </select>
                            @error('payment_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="agreed_amount"
                                name="agreed_amount"
                                value="{{ old('agreed_amount', $contract->agreed_amount) }}"
                                step="0.01"
                                min="0"
                                required
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="completed" {{ old('status', $contract->status) === 'completed' ? 'selected' : '' }}>مكتمل</option>
