                ...
                <label class="flex items-start gap-2 cursor-pointer">
                    ...
                    <span class="text-sm text-gray-700">
                        ...
                        <span class="block text-xs text-gray-500 mt-0.5">
                            12 مهمة في «قيد التخطيط» بالترتيب: بنر الموقع، تيزر قبل، رفع على الموقع، إعلان، تذكير، كفر يوتيوب، مونتاج، يوتيوب، مقاطع عرضي/طولي، جدولة، آراء — بكابي احترافي من بيانات المحاضرة.
                        </span>
                    </span>
                </label>
            </div>
