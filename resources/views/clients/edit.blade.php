        ...
        <div class="card page-header rounded-xl md:rounded-2xl p-4 md:p-6">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div class="flex items-center flex-1">
                    ...
                    <div>
                        <h2 class="text-xl md:text-2xl font-bold text-gray-800">تعديل العميل</h2>
                        <p class="text-sm md:text-base text-gray-600 hidden md:block">تعديل بيانات العميل: {{ $client->name }}</p>
                    </div>
                </div>
