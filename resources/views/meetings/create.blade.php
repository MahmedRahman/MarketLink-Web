...
@section('page-title', 'إضافة اجتماع جديد')
@section('page-description', 'إضافة اجتماع جديد إلى النظام')
        ...
        <div class="card page-header rounded-2xl p-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">إضافة اجتماع جديد</h2>
                        <p class="text-gray-600">املأ البيانات التالية لإضافة اجتماع جديد إلى النظام</p>
                    </div>
                </div>
